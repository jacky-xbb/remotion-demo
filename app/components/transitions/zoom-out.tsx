...
const ZoomOutPresentation: React.FC<
  TransitionPresentationComponentProps<ZoomOutProps>
> = ({
  children,
  ...
  const { exitZoomFactor = 0.5, enterZoomFactor = 2 } = passedProps;
...
export const zoomOut = (
  props?: ZoomOutProps
): TransitionPresentation<ZoomOutProps> => {
  return {
